...
#define SPRITE_NUMBER   2							//画面上人物数目
...
{
	int x,y;			//x,y为贴图坐标
	int direction;		//direction为目标人物的移动方向
};

//-----------------------------------【全局变量声明部分】-------------------------------------
//	描述：全局变量的声明
//------------------------------------------------------------------------------------------------
HDC		g_hdc=NULL,g_mdc= nullptr,g_bufdc = nullptr;       //全局设备环境句柄,两个全局内存句柄
HBITMAP g_hSprite[4],g_hBackGround;	//存储各个图的位图
