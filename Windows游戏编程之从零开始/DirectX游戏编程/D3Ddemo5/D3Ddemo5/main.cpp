...
#define WINDOW_TITLE	L"【致我们永不熄灭的游戏开发梦想】Direct3D的四大变换"	//为窗口标题定义的宏
...
HRESULT Direct3D_Init(HWND hwnd)
{
	...
	// 设置渲染状态，如果不关掉还是需要对应的光照和材质分量，才能显示物体来
...
VOID	Matrix_Set()
{
	...
	D3DXVECTOR3 vAt(0.0f,0.0f,0.0f);					//摄像机的位置
