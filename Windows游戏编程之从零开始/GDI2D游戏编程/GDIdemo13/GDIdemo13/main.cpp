...
#define WINDOW_TITLE L"【致我们永不熄灭的游戏开发梦想】匀速与加速运动模拟"	//为窗口标题定义的宏
...
int		g_iX=0,g_iY=0,g_iXSpeed=0,g_iYSpeed=0,g_iYGravity = 0;  //g_iX,g_iY代表贴图位置，g_iXSpeed,g_iYSpeed表示X分量和Y分量上的速度
