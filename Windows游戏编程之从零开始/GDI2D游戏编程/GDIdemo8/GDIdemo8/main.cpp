...
//描述：全局变量声明
//-----------------------------------------------------------------------
HDC g_hdc = nullptr,g_mdc = nullptr,g_bufdc = nullptr;	//全局设备环境句柄与全局内存DC句柄
HBITMAP g_hSprite = nullptr,g_hBackGround=nullptr;		//定义两个位图句柄	
...
BOOL Game_Init(HWND hwnd)
{
	...
	g_bufdc = CreateCompatibleDC(g_hdc);		//再建立一个兼容设备环境的内存DC
